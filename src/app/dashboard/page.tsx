...
import { Target, TrendingUp, RefreshCw, Users, BarChart2, Zap } from 'lucide-react'
import ICPProfile from '../components/ICPProfile'
import RecoverTab from '../components/RecoverTab'
import GenerateTab from '../components/GenerateTab'

type Tab = 'icp' | 'recover' | 'generate'
    ...
    <div className="min-h-screen bg-navy-900 text-white">
      ...
      <nav className="border-b border-slate-800 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-1.5 h-7 bg-teal-500 rounded-sm" />
          <span className="font-semibold text-white text-lg tracking-tight">SignalOps</span>
          <span className="text-xs text-slate-500 ml-2 border border-slate-700 px-2 py-0.5 rounded">Demo</span>
        </div>
